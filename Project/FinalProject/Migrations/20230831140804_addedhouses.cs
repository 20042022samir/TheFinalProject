        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorities_AspNetUsers_AppUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Motros", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistinctId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Houses_Motros_MetroId",
                        column: x => x.MetroId,
                        principalTable: "Motros",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DislikCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Houses_DistinctId",
                table: "Houses",
                column: "DistinctId");

            migrationBuilder.CreateIndex(
                name: "IX_Houses_MetroId",
                table: "Houses",
                column: "MetroId");

            migrationBuilder.CreateIndex(
                name: "IX_Houses_TypeeId",
                table: "Houses",
                column: "TypeeId");
        }
